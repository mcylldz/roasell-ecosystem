...
const Features: React.FC = () => {
  return (
    <section className="py-8 md:py-16 bg-roasell-card border-y border-white/5">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-6 md:gap-12 items-center">
            <div className="mb-2 lg:mb-0">
                <h2 className="text-xl md:text-4xl font-bold font-display mb-2 md:mb-4">
                    Neden <span className="text-roasell-gold">RoaSell?</span>
                </h2>
                <p className="text-gray-400 text-sm md:text-lg leading-relaxed">
                    RoaSell'e katılan her mağaza, ekosistemi güçlendirir. Veriler, nokta atışı çözümler sunmamıza imkan tanır.
                </p>
            </div>
